package com.ren.fastdevelop.http.OkHttp;
...
//    }
    ...
    public static OkHttpClient getOkHttpClient(Interceptor cacheControl) {
        if (cacheControl != null)
            return OkHttpClient(cacheControl);
        return OkHttpClient(new FromNetWorkControlInterceptor());
    }

    private static OkHttpClient OkHttpClient(Interceptor cacheControl) {
        //定制OkHttp
